...
ANSITerminal.print_string [] "                                      ";
 draw_edge 39 "/" edges;
  ...
  draw_edge 23 "\\" edges;
   ANSITerminal.print_string [] "\n";                  
ANSITerminal.print_string [] "                        ";
 draw_node 38 "38" nodes; draw_edge 49 "---49--" edges;
  draw_node 28 "28" nodes; draw_tile 7 "       Ore 7     " tiles;
   draw_node 17 "17" nodes; draw_edge 18 "---18--" edges;
    draw_node 7 "07" nodes; ANSITerminal.print_string [] "\n";
ANSITerminal.print_string [] "                        ";
 draw_edge 54 "/" edges;
  ANSITerminal.print_string [] "             ";
   draw_edge 40 "\\" edges;
 ...
 draw_node 47 "47" nodes;
  draw_edge 62 "---62--" edges;
   draw_node 39 "39" nodes;
    draw_tile 12 "      Brick 12   " tiles;
     draw_node 29 "29" nodes;
      draw_edge 34 "---34--" edges;
       draw_node 18 "18" nodes;
        draw_tile 3 "      Brick 3    " tiles;
         draw_node 8 "08" nodes;
          draw_edge 6 "---06--" edges;
           draw_node 0 "00" nodes; ANSITerminal.print_string [] "\n";               
ANSITerminal.print_string [] "        ";
 draw_edge 66 "/" edges;
  ANSITerminal.print_string [] "             ";
   draw_edge 55 "\\" edges; ANSITerminal.print_string [] "                 ";
    draw_edge 41 "/" edges; ANSITerminal.print_string [] "             ";
     draw_edge 25 "\\" edges; ANSITerminal.print_string [] "                 ";
      draw_edge 11 "/" edges; ANSITerminal.print_string [] "             ";
       draw_edge 0 "\\" edges; ANSITerminal.print_string [] "\n";
ANSITerminal.print_string [] "       ";
 draw_edge 66 "66" edges;
  ANSITerminal.print_string [] "             ";
   draw_edge 55 "55" edges; ANSITerminal.print_string [] "               ";
    draw_edge 41 "41" edges; ANSITerminal.print_string [] "             ";
     draw_edge 25 "25" edges; ANSITerminal.print_string [] "               ";
      draw_edge 11 "11" edges; ANSITerminal.print_string [] "             ";
       draw_edge 0 "00" edges; ANSITerminal.print_string [] "\n";
ANSITerminal.print_string [] "      ";
 draw_edge 66 "/" edges; ANSITerminal.print_string [] "                 ";
  draw_edge 55 "\\" edges; ANSITerminal.print_string [] "             ";
   draw_edge 41 "/" edges; ANSITerminal.print_string [] "                 ";
    draw_edge 25 "\\" edges; ANSITerminal.print_string [] "             ";
     draw_edge 11 "/" edges; ANSITerminal.print_string [] "                 ";
...
ANSITerminal.print_string [] "   ";
 draw_node 48 "48" nodes;
  draw_tile 16 "      Wheat 16   " tiles;
   draw_node 40 "40" nodes;
    draw_edge 50 "---50--" edges;
     draw_node 30 "30" nodes;
      draw_tile 8 "      Sheep 8    " tiles;
       draw_node 19 "19" nodes;
        draw_edge 19 "---19--" edges;
         draw_node 9 "09" nodes;
          draw_tile 0 "      Wood 0     " tiles;
           draw_node 1 "01" nodes;
            ANSITerminal.print_string [] "\n";
ANSITerminal.print_string [] "      ";
 draw_edge 67 "\\" edges;
  ANSITerminal.print_string [] "                 ";
   draw_edge 56 "/" edges; ANSITerminal.print_string [] "             ";
    draw_edge 42 "\\" edges; ANSITerminal.print_string [] "                 ";
    draw_edge 26 "/" edges; ANSITerminal.print_string [] "             ";
     draw_edge 12 "\\" edges; ANSITerminal.print_string [] "                 ";
      draw_edge 1 "/" edges; ANSITerminal.print_string [] "\n";
ANSITerminal.print_string [] "      ";
   ...
   draw_edge 56 "56" edges;
    ANSITerminal.print_string [] "             ";
     draw_edge 42 "42" edges;
      ANSITerminal.print_string [] "               ";
       draw_edge 26 "26" edges; ANSITerminal.print_string [] "             ";
        draw_edge 12 "12" edges;
         ANSITerminal.print_string [] "               ";
          draw_edge 1 "01" edges; ANSITerminal.print_string [] "\n";
ANSITerminal.print_string [] "        ";
 draw_edge 67 "\\" edges;
  ANSITerminal.print_string [] "             ";
   draw_edge 56 "/" edges;
