...
let build_road_test (name : string) (ind : int) (edge : Board.edge) (expected_output : Board.edge list) : test = name >:: fun _ ->
  assert_equal expected_output (build_road ind edge) 

let build_settlement_test (name : string) (ind : int) (node : Board.node) (expected_output : Board.node list) : test = name >:: fun _ ->
  assert_equal expected_output (build_settlement ind node)
